...
$$.Control = {"": ["canvas", "keyW!", "keyA!", "keyD!", "entities"],
 ...
 update$1: function(netsock) {
  ...
  for (t1 = $.iterator(this.entities); t1.get$hasNext() === true;) {
    ...
    if ($.eqB(this.keyW, 1) && !$.eqB(t2.get$state(), 0))
      keysDown.push('W');
    if ($.eqB(this.keyA, 1))
      keysDown.push('A');
    if ($.eqB(this.keyD, 1))
...
$$.State = {"": ["_state?"],
 "super": "Object",
 operator$eq$1: function(state) {
  return $.eq(state, state.get$state());
},
 get$state: function() {
  return this._state;
},
 set$state: function(s) {
  this._state = s;
  return s;
},
 State$1: function(s) {
...
$$.Obstacle = {"": ["box", "image="],
 ...
 Obstacle$ground$1: function(canv) {
  this.box = $.BoundingBox$($.Point$(0, 600), $.Point$(1500, canv.get$height()));
}
};
...
$$.Game = {"": ["canv", "ctx?", "netsock", "name", "id?", "ground", "mainPlayer", "players", "renderSystem", "physicsSystem", "controlSystem", "bg"],
 ...
 loadEntities$1: function(playerMap) {
  ...
  this.renderSystem.addEntity$1(this.ground);
},
...
$.$defineNativeClass('PopStateEvent', {"": [],
 get$state: function() {
  return $._convertNativeToDart_SerializedScriptValue(this.get$_lib_state());
},
 get$_lib_state: function() {
  return this.state;
}
});
